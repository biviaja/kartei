    ...
    <main role="main" class="container">
      <form name="FORM_Fichas" id="FORM_Fichas" method="post" onsubmit="return false;">
        ...
        <div id="carrossel-passos" class="carousel slide" data-ride="carousel" data-interval="false" data-touch="false">
          <h3 class="carousel-indicators d-none">
              ...
              <div class="col-12 finalizado">
                <div class="card">
                  ...
                  <div class="card-body row px-3">
                    <div class="col-8">
                      ...
                      <div class="d-flex col-12 mb-3">
                        ...
                        <div class="custom-control custom-radio custom-control-inline ml-3">
                          ...
                          <label class="custom-control-label" for="masc_Final">Masculino</label>
                        </div>
                        <div class="custom-control custom-radio custom-control-inline">
                          ...
                          <label class="custom-control-label" for="fem_Final">Feminino</label>
                        </div>
                      </div>
                      <div class="form-group col-12">
                        <div class="row px-3">
                      ...
                      <div class="form-group col-12">
                        ...
                        <div id="sugestao1" class="sugestao d-none"> <!-- DIV Balão Sugestão --> 
                            <div class="sugestao-conteudo">
                              ...
                              <ul class="mt-3">
                                <li class="custom-control custom-radio pt-0">
                                  <input class="custom-control-input" type="radio" name="TX_ESCOLHECONJUGE" id="5" value="C1">
                                  <label class="custom-control-label" for="5">Fulano de Tal</label>
                                </li>
                                <li class="custom-control custom-radio pt-0">
                                  <input class="custom-control-input" type="radio" name="TX_ESCOLHECONJUGE" id="6" value="C2">
                                  <label class="custom-control-label" for="6">Beltrano de Tal</label>
                                </li>
                                <li class="custom-control custom-radio pt-0">
                                  <input class="custom-control-input" type="radio" name="TX_ESCOLHECONJUGE" id="7" value="C3">
                                  <label class="custom-control-label" for="7">Sicrano de Tal</label>
                                </li>
                                <li class="custom-control custom-radio pt-0">
                                  <input class="custom-control-input" type="radio" name="TX_ESCOLHECONJUGE" id="8" value="C3">
                                  <label class="custom-control-label" for="8">Nenhuma delas</label>
                                </li>
                              </ul>
                            </div>                            
                            <div class="seta"></div>
                        ...
                        <div class="row px-3 align-items-end">
                          ...
                          <div class='sugestao d-none' id='sugestao2'> <!-- DIV Balão Sugestão --> 
                                  ...
                                  <div class='sugestao-conteudo'>
                                    ...
                                    <ul class="mt-3">
                                      <li class='custom-control custom-radio pt-0'>
                                        <input class='custom-control-input' type='radio' name='TX_ESCOLHECONJUGE' id='1' value='C1'>
                                        <label class='custom-control-label' for='1'>Fulano de Tal</label>
                                      </li>
                                      <li class='custom-control custom-radio pt-0'>
                                        <input class='custom-control-input' type='radio' name='TX_ESCOLHECONJUGE' id='2' value='C2'>
                                        <label class='custom-control-label' for='2'>Beltrano de Tal</label>
                                      </li>
                                      <li class='custom-control custom-radio pt-0'>
                                        <input class='custom-control-input' type='radio' name='TX_ESCOLHECONJUGE' id='3' value='C3'>
                                        <label class='custom-control-label' for='3'>Sicrano de Tal</label>
                                      </li>
                                      <li class='custom-control custom-radio pt-0'>
                                        <input class='custom-control-input' type='radio' name='TX_ESCOLHECONJUGE' id='4' value='C3'>
                                        <label class='custom-control-label' for='4'>Nenhum deles</label>
                                      </li>
                                    </ul>
                                  </div>
                               </div>
                    ...
                    <div class="col-4">              
                      <textarea class="form-control" style="height:100vh" id="Obs6" name="Obs6"><?php echo $_SESSION['ficha']['varObs']; ?></textarea>
                      <div class="card w-100 card-imgs">
                  <div class="card-header obs">
                    <h4 class="col-12 px-0">Imagens</h4>
                  </div> 
                  <div class="card-body">
                    <div class="row mx-2">
                      <div class="col-4 px-1"><a href="" data-toggle="modal" data-target="#modalImg1"><img src="img/ARI_Kartei_LANGENBACH_Karl.jpg" class="img-fluid" alt="ficha" id="img1">
                        </a></div>
                      <div class="col-4 px-1"><a href="" data-toggle="modal" data-target="#modalImg2"><img src="img/projekt2.jpg" class="img-fluid" alt="ficha" id="img2">
                        </a></div>
                      <div class="col-4 px-1">
                        <div class="adImg d-flex align-items-center">
                          Adicionar imagem
